...
git clone https://github.com/Xiaomi-pad-6-development/android_device_xiaomi_sm8250-common.git -b banana-14 device/xiaomi/sm8250-common
...
echo 'cloning kernel'
git clone https://github.com/Xiaomi-pad-6-development/kernel_xiaomi_sm8250.git kernel/xiaomi/sm8250 --depth=1
